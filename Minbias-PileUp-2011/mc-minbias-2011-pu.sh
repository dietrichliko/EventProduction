#!/bin/bash -x
#
# Simulate MinBias 7TeV for 2011 using CMS Opendata container using CMS Connect
#
# Parameter for the simulation follow http://opendata.cern.ch/record/36 (yilun.wu@Vanderbilt.Edu)
#
...
# Confdb is send with the job to avoid problems with /cvmfs inside the container
